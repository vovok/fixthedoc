"""
Django settings for fixthedoc project.
...
WSGI_APPLICATION = 'fixthedoc.wsgi.application'
...
# Uploaded files (Images, Videos, Documents)
MEDIA_URL = '/media/'
...
CRONJOBS = [('5 * * * *', 'ui.cron.add_hash_to_bch')]
